USE [Name_Cache_Test]
GO
/****** Object:  Table [test_name].[Deprecated]    Script Date: 11/07/2011 11:24:35 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [test_name].[Deprecated](
	[DeprecatedOldId] [uniqueidentifier] NOT NULL,
	[DeprecatedNewId] [uniqueidentifier] NULL,
	[TableName] [nvarchar](100) NOT NULL,
	[DeprecatedDate] [datetime] NOT NULL
) ON [PRIMARY]
GO
/****** Object:  Table [test_name].[Metadata]    Script Date: 11/07/2011 11:24:35 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [test_name].[Metadata](
...
GO
/****** Object:  Table [test_name].[Publication]    Script Date: 11/07/2011 11:24:35 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
SET ANSI_PADDING ON
GO
CREATE TABLE [test_name].[Publication](
...
GO
/****** Object:  Table [test_name].[VernacularUse]    Script Date: 11/07/2011 11:24:35 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [test_name].[VernacularUse](
...
GO
/****** Object:  Table [test_name].[Vernacular]    Script Date: 11/07/2011 11:24:35 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [test_name].[Vernacular](
	[VernacularId] [uniqueidentifier] NOT NULL,
...
GO
/****** Object:  Table [test_name].[OAI]    Script Date: 11/07/2011 11:24:35 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [test_name].[Name]    Script Date: 11/07/2011 11:24:35 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [test_name].[Name](
...
GO
/****** Object:  Table [test_name].[TaxonNameUse]    Script Date: 11/07/2011 11:24:35 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [test_name].[TaxonNameUse](
...
GO
/****** Object:  Table [test_name].[PublicationTitle]    Script Date: 11/07/2011 11:24:35 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
SET ANSI_PADDING ON
GO
CREATE TABLE [test_name].[PublicationTitle](
	[PublicationId] [uniqueidentifier] NOT NULL,
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [test_name].[VernacularConcept]    Script Date: 11/07/2011 11:24:35 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [test_name].[VernacularConcept](
...
GO
/****** Object:  Table [test_name].[TaxonConcept]    Script Date: 11/07/2011 11:24:35 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
SET ANSI_PADDING ON
GO
CREATE TABLE [test_name].[TaxonConcept](
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [test_name].[Biostatus]    Script Date: 11/07/2011 11:24:35 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [test_name].[Biostatus](
...
GO
/****** Object:  Table [test_name].[ConceptRelationship]    Script Date: 11/07/2011 11:24:35 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
SET ANSI_PADDING ON
GO
CREATE TABLE [test_name].[ConceptRelationship](
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [test_name].[ConceptApplication]    Script Date: 11/07/2011 11:24:35 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
SET ANSI_PADDING ON
GO
CREATE TABLE [test_name].[ConceptApplication](
...
SET ANSI_PADDING OFF
GO
/****** Object:  Default [DF_OAI_ID_OAI_ID]    Script Date: 11/07/2011 11:24:35 ******/
ALTER TABLE [test_name].[OAI] ADD  CONSTRAINT [DF_OAI_ID_OAI_ID]  DEFAULT (newid()) FOR [OAI_ID]
GO
/****** Object:  Default [DF_VernacularUse_VernacularUseId]    Script Date: 11/07/2011 11:24:35 ******/
ALTER TABLE [test_name].[VernacularUse] ADD  CONSTRAINT [DF_VernacularUse_VernacularUseId]  DEFAULT (newid()) FOR [VernacularUseId]
GO
/****** Object:  ForeignKey [FK_Biostatus_Name]    Script Date: 11/07/2011 11:24:35 ******/
...
GO
/****** Object:  ForeignKey [FK_Biostatus_Publication]    Script Date: 11/07/2011 11:24:35 ******/
...
GO
/****** Object:  ForeignKey [FK_ConceptApplication_VernacularConcept]    Script Date: 11/07/2011 11:24:35 ******/
...
GO
/****** Object:  ForeignKey [FK_ConceptApplication_VernacularConcept1]    Script Date: 11/07/2011 11:24:35 ******/
...
GO
/****** Object:  ForeignKey [FK_ConceptRelationship_TaxonConcept]    Script Date: 11/07/2011 11:24:35 ******/
...
GO
/****** Object:  ForeignKey [FK_ConceptRelationship_TaxonConcept1]    Script Date: 11/07/2011 11:24:35 ******/
...
GO
/****** Object:  ForeignKey [FK_Name_Name]    Script Date: 11/07/2011 11:24:35 ******/
...
GO
/****** Object:  ForeignKey [FK_Name_Name1]    Script Date: 11/07/2011 11:24:35 ******/
...
GO
/****** Object:  ForeignKey [FK_Name_Name2]    Script Date: 11/07/2011 11:24:35 ******/
...
GO
/****** Object:  ForeignKey [FK_Name_Name3]    Script Date: 11/07/2011 11:24:35 ******/
...
GO
/****** Object:  ForeignKey [FK_Name_Name4]    Script Date: 11/07/2011 11:24:35 ******/
...
GO
/****** Object:  ForeignKey [FK_Name_Publication]    Script Date: 11/07/2011 11:24:35 ******/
...
GO
/****** Object:  ForeignKey [FK_PublicationTitle_Publication]    Script Date: 11/07/2011 11:24:35 ******/
...
GO
/****** Object:  ForeignKey [FK_TaxonConcept_Name]    Script Date: 11/07/2011 11:24:35 ******/
...
GO
/****** Object:  ForeignKey [FK_TaxonConcept_Publication]    Script Date: 11/07/2011 11:24:35 ******/
...
GO
/****** Object:  ForeignKey [FK_NameBasedConcept_Name]    Script Date: 11/07/2011 11:24:35 ******/
...
GO
/****** Object:  ForeignKey [FK_NameBasedConcept_Name1]    Script Date: 11/07/2011 11:24:35 ******/
...
GO
/****** Object:  ForeignKey [FK_NameBasedConcept_Name2]    Script Date: 11/07/2011 11:24:35 ******/
...
GO
/****** Object:  ForeignKey [FK_NameBasedConcept_Publication]    Script Date: 11/07/2011 11:24:35 ******/
...
GO
/****** Object:  ForeignKey [FK_VernacularConcept_Publication]    Script Date: 11/07/2011 11:24:35 ******/
...
GO
/****** Object:  ForeignKey [FK_VernacularConcept_Vernacular]    Script Date: 11/07/2011 11:24:35 ******/
