...
delete from [NAME_CACHE.DATABASES.LANDCARERESEARCH.CO.NZ].name_cache.Hosted_name.Publication

select distinct	
	PublishedInId 
into #Refs
from [NAME_CACHE.DATABASES.LANDCARERESEARCH.CO.NZ].name_cache.Hosted_name.Name
	where PublishedInId is not null
union
select distinct	
	PublishedInId 
from [NAME_CACHE.DATABASES.LANDCARERESEARCH.CO.NZ].name_cache.Hosted_name.Vernacular
	where PublishedInId is not null
union
select distinct
	AccordingToId
from [NAME_CACHE.DATABASES.LANDCARERESEARCH.CO.NZ].name_cache.Hosted_name.taxonconcept
	where AccordingToId is not null
union	
select distinct
	AccordingToId
from [NAME_CACHE.DATABASES.LANDCARERESEARCH.CO.NZ].name_cache.Hosted_name.vernacularconcept
	where AccordingToId is not null
union
select distinct
	AccordingToId
from [NAME_CACHE.DATABASES.LANDCARERESEARCH.CO.NZ].name_cache.Hosted_name.TaxonNameUse
	where AccordingToId is not null
union
select distinct
	AccordingToId
from [NAME_CACHE.DATABASES.LANDCARERESEARCH.CO.NZ].name_cache.Hosted_name.VernacularUse
	where AccordingToId is not null
union
select distinct
	AccordingToId
from [NAME_CACHE.DATABASES.LANDCARERESEARCH.CO.NZ].name_cache.Hosted_name.Biostatus
	where AccordingToId is not null
...
insert into [NAME_CACHE.DATABASES.LANDCARERESEARCH.CO.NZ].name_cache.Hosted_name.Publication(
...
from  [NAME_CACHE.DATABASES.LANDCARERESEARCH.CO.NZ].name_cache.Hosted_name.Publication pub
...
insert into [NAME_CACHE.DATABASES.LANDCARERESEARCH.CO.NZ].name_cache.Hosted_name.PublicationTitle(
...
select Pub.PublicationId,
	...
	'full'
	from
	[NAME_CACHE.DATABASES.LANDCARERESEARCH.CO.NZ].name_cache.Hosted_name.Publication pub
...
select Pub.PublicationId,
	...
	from
	[NAME_CACHE.DATABASES.LANDCARERESEARCH.CO.NZ].name_cache.Hosted_name.Publication pub
	inner join [NAME_CACHE.DATABASES.LANDCARERESEARCH.CO.NZ].name_cache.Hosted_name.Publication pub2
...
select Pub.PublicationId,
	...
	inner join [NAME_CACHE.DATABASES.LANDCARERESEARCH.CO.NZ].name_cache.Hosted_name.Publication pub2
		on Pub.ParentPublicationId = pub2.publicationid
	inner join [NAME_CACHE.DATABASES.LANDCARERESEARCH.CO.NZ].name_cache.Hosted_name.Publication pub3
...
--standardise
update [NAME_CACHE.DATABASES.LANDCARERESEARCH.CO.NZ].name_cache.Hosted_name.publication set [type] = 'Article' where [type] = 'Article in journal'
update [NAME_CACHE.DATABASES.LANDCARERESEARCH.CO.NZ].name_cache.Hosted_name.publication set [type] = 'Article' where [type] = 'Article in magazine'
update [NAME_CACHE.DATABASES.LANDCARERESEARCH.CO.NZ].name_cache.Hosted_name.publication set [type] = 'Serial' where [type] = 'Serial (book/monograph) in series'
update [NAME_CACHE.DATABASES.LANDCARERESEARCH.CO.NZ].name_cache.Hosted_name.publication set [type] = 'Book' where [type] = 'Book (in series)'
update [NAME_CACHE.DATABASES.LANDCARERESEARCH.CO.NZ].name_cache.Hosted_name.publication set [type] = 'Chapter' where [type] = 'Chapter in book (in series)'
update [NAME_CACHE.DATABASES.LANDCARERESEARCH.CO.NZ].name_cache.Hosted_name.publication set [type] = 'Electronic source' where [type] = 'Electronic citation in electronic source'
update [NAME_CACHE.DATABASES.LANDCARERESEARCH.CO.NZ].name_cache.Hosted_name.publication set [type] = 'Unpublished' where [type] = 'Unpublished work (in series)'
