CREATE PROCEDURE dwc_NZIB.[sprTransferNZORToDwC_NZIB2]	
AS
	...
	select distinct n.ProviderRecordID,
		...
		n.ModifiedDate,
		'' as Rights,
		'New Zealand Inventory of Biodiversity' as RightsHolder,
		'' as AccessRights,
	...
	inner join dwc_NZIB.Taxon t on t.TaxonID = nto.ProviderRecordID collate Latin1_General_CI_AS
	...
	select distinct n.ProviderRecordID,
		...
		'New Zealand Inventory of Biodiversity' as Rights, 
		'' as TaxonRemarks,
		'' as Type
	from provider.Name n
	inner join dwc_NZIB.Taxon t on t.TaxonID = n.ProviderRecordID collate Latin1_General_CI_AS
	inner join provider.Concept c on c.NameID = n.NameID
