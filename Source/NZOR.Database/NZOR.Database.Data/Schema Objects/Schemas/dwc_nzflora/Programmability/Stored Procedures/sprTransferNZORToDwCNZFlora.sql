CREATE PROCEDURE dwc_nzflora.[sprTransferNZORToDwC_nzflora]	
AS
	...
	inner join dwc_nzflora.Taxon t on t.TaxonID = cto.ProviderRecordID
	...
	select distinct c.ProviderRecordID,
		...
		'' as Type
	from provider.Concept c
	inner join dwc_nzflora.Taxon t on t.TaxonID = c.ProviderRecordID
	inner join provider.Name n on n.NameID = c.NameID
	...
	select distinct t.TaxonID,
		...
		null as StartDay,
		null as EndDay,
		'http://nzflora.landcareresearch.co.nz/default.aspx?NameId=' + c.ProviderNameID as Source,
		null as Remarks
	...
	select distinct c.TaxonID,
		...
		null as StartDay,
		null as EndDay,
		'http://nzflora.landcareresearch.co.nz/default.aspx?NameId=' + pc.ProviderNameID as Source,
		null as Remarks
