...
delete cr 
from consensus.ConceptRelationship cr
inner join consensus.Concept c on c.ConceptID = cr.ToConceptID
inner join consensus.Name n on n.NameID = c.NameID
inner join dbo.TaxonRank tr on tr.TaxonRankID = n.TaxonRankID
where tr.SortOrder > 1600
...
inner join dbo.TaxonRank tr on tr.TaxonRankID = n.TaxonRankID
where tr.SortOrder > 1600 or n.DataSourceID = '38708533-E064-45A4-AB00-CDD76075C2B6'
...
inner join dbo.TaxonRank tr on tr.TaxonRankID = n.TaxonRankID
where SortOrder > 1600 or n.DataSourceID = '38708533-E064-45A4-AB00-CDD76075C2B6'

delete dbo.DataSource where ProviderID = '7B5CC893-C710-4119-ADE5-B00A997CEEAA'
...
if (not exists(select conceptid from consensus.Name pn
...
begin
	...
	INSERT INTO [consensus].[Concept] ([ConceptID] ,[NameID] ,[AccordingToReferenceID] ,[Orthography] ,[AddedDate] ,[ModifiedDate])
	...
	INSERT INTO [consensus].[ConceptRelationship] ([ConceptRelationshipID] ,[FromConceptID] ,[ToConceptID] ,[ConceptRelationshipTypeID] ,[Sequence] ,[AddedDate] ,[ModifiedDate])
...
--test Provider
INSERT [admin].[Provider] ([ProviderID], [Name], Code) VALUES (N'7B5CC893-C710-4119-ADE5-B00A997CEEAA', N'Test Provider', 'TEST')
insert [admin].DataSource values('38708533-E064-45A4-AB00-CDD76075C2B6', '7B5CC893-C710-4119-ADE5-B00A997CEEAA', 'TEST_DS')

 -------------   1. simple test Family   ---------------------
 
INSERT INTO [consensus].[Name] ([NameID] ,[FullName] ,[TaxonRankID] ,[NameClassID] ,[GoverningCode] ,[AddedDate] ,[ModifiedDate])
...
INSERT INTO [consensus].[NameProperty] ([NamePropertyID] ,[NameID] ,[NamePropertyTypeID] ,[Value] ,[RelatedID] ,[Sequence] ,[AddedDate] ,[ModifiedDate])
...
go
	--flat name
	delete consensus.StackedName where seednameid = '46E9A632-2B47-45A7-9146-03F4BB25B12F'
    INSERT consensus.StackedName EXEC consensus.sprSelect_StackedNameToRoot '46E9A632-2B47-45A7-9146-03F4BB25B12F'
...
INSERT INTO provider.[Name] ([NameID] ,[LinkStatus], [FullName] ,[TaxonRankID] ,[NameClassID] ,[GoverningCode] , DataSourceID, ProviderRecordID, [AddedDate] ,[ProviderModifiedDate])
...
INSERT INTO provider.[NameProperty] ([NamePropertyID] ,[NameID] ,[NamePropertyTypeID] ,[Value] ,[RelatedID] ,[Sequence])
...
go
	...
	--child of Asterales
INSERT INTO provider.[Concept] ([ConceptID], LinkStatus,[NameID] ,[AccordingToReferenceID] ,[Orthography] ,[AddedDate] ,[ProviderModifiedDate], DataSourceID, ProviderRecordID)
...
go
	--flat name
	delete consensus.StackedName where seednameid = '87C799BC-DA5F-404C-921C-5BBF12A9A52C'
    INSERT consensus.StackedName EXEC consensus.sprSelect_StackedNameToRoot '87C799BC-DA5F-404C-921C-5BBF12A9A52C'
...
go
	--flat name
	delete consensus.StackedName where seednameid = '79B46D62-978E-4DFD-A634-559D399E006B'
    INSERT consensus.StackedName EXEC consensus.sprSelect_StackedNameToRoot '79B46D62-978E-4DFD-A634-559D399E006B'
