...
INSERT INTO [cons].[Name] ([NameID] ,[FullName] ,[TaxonRankID] ,[NameClassID] ,[OriginalOrthography] ,[GoverningCode] ,[AddedDate] ,[UpdatedDate])
     VALUES ( '87C799BC-DA5F-404C-921C-5BBF12A9A52C', 'Testgenus Sm.', '20552EB6-1BF0-4073-A021-A6C7A89B7F14', 'A5233111-61A0-4AE6-9C2B-5E8E71F1473A', null, 'ICBN', getdate(), null )
...
INSERT INTO prov.[Name] ([NameID] ,[FullName] ,[TaxonRankID] ,[NameClassID] ,[OriginalOrthography] ,[GoverningCode] , ProviderID, ProviderRecordID, [AddedDate] ,[ProviderUpdatedDate])
     VALUES ('3CF39BEE-E713-4063-9CA5-5EB05D6CE8F1', 'Testgenus', '20552EB6-1BF0-4073-A021-A6C7A89B7F14', 'A5233111-61A0-4AE6-9C2B-5E8E71F1473A', null, 'ICBN', '7B5CC893-C710-4119-ADE5-B00A997CEEAA', '6816FBAC-80C2-4533-8986-5235A15B051C', getdate(), getdate())
...
go
	...
	--child of Testaceae
INSERT INTO prov.[Concept] ([ConceptID] ,[NameID] ,[AccordingToReferenceID] ,[Orthography] ,[AddedDate] ,[ProviderUpdatedDate], ProviderID, ProviderRecordID)
     VALUES ('7D82F575-5C79-413A-B8AF-98D014370F39', '3CF39BEE-E713-4063-9CA5-5EB05D6CE8F1', null, null, getdate(), getdate(), '7B5CC893-C710-4119-ADE5-B00A997CEEAA', newid()) --genus concept
