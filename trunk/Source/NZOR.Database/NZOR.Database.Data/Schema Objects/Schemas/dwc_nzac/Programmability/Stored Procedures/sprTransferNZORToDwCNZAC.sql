CREATE PROCEDURE dwc_nzac.[sprTransferNZORToDwC_nzac]	
AS
	...
	select distinct c.ProviderRecordID,
		...
		n.ModifiedDate,
		'' as Rights,
		'NZAC' as RightsHolder,
		'' as AccessRights,
		'' as BibliographicCitation,
		'' as InformationWitheld,
		'http://nzbugs.landcareresearch.co.nz/default.aspx?NameId=' + cast(n.ProviderRecordID as varchar(38)) as Source,
		'New Zealand Arthropod Names',
		c.AddedDate,
	...
	inner join dwc_nzac.Taxon t on t.TaxonID = cto.ProviderRecordID
	...
	select distinct c.ProviderRecordID,
		...
		'' as Type
	from provider.Concept c
	inner join dwc_nzac.Taxon t on t.TaxonID = c.ProviderRecordID
	inner join provider.Name n on n.NameID = c.NameID
