...
{
    public class NamesWithRankAndCanonical : BaseMatcher
    {        
                ...
                using (SqlConnection cnn = new SqlConnection(DBConnectionString))
                {
                    ...
                    using (SqlCommand cmd = cnn.CreateCommand())
                    {
                        cmd.CommandText = @"
                            ...
                            where np.Value = '" + pn.Canonical.Replace("'", "''") + "' and n.TaxonRankID = '" + pn.TaxonRankID.ToString() + "' and n.GoverningCode = '" + pn.GoverningCode + "'; ";
