...
where (pn.FullName > 'zzzz' or pn.FullName < 'A' or pn.FullName like 'X%') and tr.TaxonRankID = @rankId
...
where (pn.DataSourceID = @dataSourceId or @dataSourceId is null) and (pn.FullName > 'zzzz' or pn.FullName < 'A' or pn.FullName like 'X%') and tr.TaxonRankID = @rankId
