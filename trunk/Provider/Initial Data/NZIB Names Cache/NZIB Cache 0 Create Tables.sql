USE [Name_Cache]
GO
/****** Object:  Table [nzib_name].[VernacularUse]    Script Date: 11/03/2011 16:30:12 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [nzib_name].[VernacularUse](
...
GO
/****** Object:  Table [nzib_name].[Vernacular]    Script Date: 11/03/2011 16:30:12 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [nzib_name].[Vernacular](
	[VernacularId] [uniqueidentifier] NOT NULL,
...
GO
/****** Object:  Table [nzib_name].[Metadata]    Script Date: 11/03/2011 16:30:12 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [nzib_name].[Metadata](
...
GO
/****** Object:  Table [nzib_name].[OAI]    Script Date: 11/03/2011 16:30:12 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [nzib_name].[Publication]    Script Date: 11/03/2011 16:30:12 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
SET ANSI_PADDING ON
GO
CREATE TABLE [nzib_name].[Publication](
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [nzib_name].[Deprecated]    Script Date: 11/03/2011 16:30:12 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [nzib_name].[Deprecated](
...
GO
/****** Object:  Table [nzib_name].[VernacularConcept]    Script Date: 11/03/2011 16:30:12 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [nzib_name].[VernacularConcept](
...
GO
/****** Object:  Table [nzib_name].[Name]    Script Date: 11/03/2011 16:30:12 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [nzib_name].[Name](
...
GO
/****** Object:  Table [nzib_name].[TaxonNameUse]    Script Date: 11/03/2011 16:30:12 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [nzib_name].[TaxonNameUse](
...
GO
/****** Object:  Table [nzib_name].[TaxonConcept]    Script Date: 11/03/2011 16:30:12 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
SET ANSI_PADDING ON
GO
CREATE TABLE [nzib_name].[TaxonConcept](
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [nzib_name].[Biostatus]    Script Date: 11/03/2011 16:30:12 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [nzib_name].[Biostatus](
...
GO
/****** Object:  Table [nzib_name].[PublicationTitle]    Script Date: 11/03/2011 16:30:12 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
SET ANSI_PADDING ON
GO
CREATE TABLE [nzib_name].[PublicationTitle](
	[PublicationId] [uniqueidentifier] NOT NULL,
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [nzib_name].[ConceptApplication]    Script Date: 11/03/2011 16:30:12 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
SET ANSI_PADDING ON
GO
CREATE TABLE [nzib_name].[ConceptApplication](
...
CREATE TABLE [nzib_name].[ManagementStatus](
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [nzib_name].[ConceptRelationship]    Script Date: 11/03/2011 16:30:12 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
SET ANSI_PADDING ON
GO
CREATE TABLE [nzib_name].[ConceptRelationship](
...
SET ANSI_PADDING OFF
GO
/****** Object:  Default [DF_VernacularUse_VernacularUseId]    Script Date: 11/03/2011 16:30:12 ******/
ALTER TABLE [nzib_name].[VernacularUse] ADD  CONSTRAINT [DF_VernacularUse_VernacularUseId]  DEFAULT (newid()) FOR [VernacularUseId]
GO
/****** Object:  ForeignKey [FK_Biostatus_Name]    Script Date: 11/03/2011 16:30:12 ******/
...
GO
/****** Object:  ForeignKey [FK_Biostatus_Publication]    Script Date: 11/03/2011 16:30:12 ******/
...
GO
/****** Object:  ForeignKey [FK_ConceptApplication_VernacularConcept]    Script Date: 11/03/2011 16:30:12 ******/
...
GO
/****** Object:  ForeignKey [FK_ConceptApplication_VernacularConcept1]    Script Date: 11/03/2011 16:30:12 ******/
...
GO
/****** Object:  ForeignKey [FK_ConceptRelationship_TaxonConcept]    Script Date: 11/03/2011 16:30:12 ******/
...
GO
/****** Object:  ForeignKey [FK_ConceptRelationship_TaxonConcept1]    Script Date: 11/03/2011 16:30:12 ******/
...
GO
/****** Object:  ForeignKey [FK_Name_Name]    Script Date: 11/03/2011 16:30:12 ******/
...
GO
/****** Object:  ForeignKey [FK_Name_Name1]    Script Date: 11/03/2011 16:30:12 ******/
...
GO
/****** Object:  ForeignKey [FK_Name_Name2]    Script Date: 11/03/2011 16:30:12 ******/
...
GO
/****** Object:  ForeignKey [FK_Name_Name3]    Script Date: 11/03/2011 16:30:12 ******/
...
GO
/****** Object:  ForeignKey [FK_Name_Name4]    Script Date: 11/03/2011 16:30:12 ******/
...
GO
/****** Object:  ForeignKey [FK_Name_Publication]    Script Date: 11/03/2011 16:30:12 ******/
...
GO
/****** Object:  ForeignKey [FK_PublicationTitle_Publication]    Script Date: 11/03/2011 16:30:12 ******/
...
GO
/****** Object:  ForeignKey [FK_TaxonConcept_Name]    Script Date: 11/03/2011 16:30:12 ******/
...
GO
/****** Object:  ForeignKey [FK_TaxonConcept_Publication]    Script Date: 11/03/2011 16:30:12 ******/
...
GO
/****** Object:  ForeignKey [FK_NameBasedConcept_Name]    Script Date: 11/03/2011 16:30:12 ******/
...
GO
/****** Object:  ForeignKey [FK_NameBasedConcept_Name1]    Script Date: 11/03/2011 16:30:12 ******/
...
GO
/****** Object:  ForeignKey [FK_NameBasedConcept_Name2]    Script Date: 11/03/2011 16:30:12 ******/
...
GO
/****** Object:  ForeignKey [FK_NameBasedConcept_Publication]    Script Date: 11/03/2011 16:30:12 ******/
...
GO
/****** Object:  ForeignKey [FK_VernacularConcept_Publication]    Script Date: 11/03/2011 16:30:12 ******/
...
GO
/****** Object:  ForeignKey [FK_VernacularConcept_Vernacular]    Script Date: 11/03/2011 16:30:12 ******/
