...
delete [NAME_CACHE.DATABASES.LANDCARERESEARCH.CO.NZ].name_cache.Hosted_name.TaxonConcept
delete [NAME_CACHE.DATABASES.LANDCARERESEARCH.CO.NZ].name_cache.Hosted_name.TaxonNameUse


insert into [NAME_CACHE.DATABASES.LANDCARERESEARCH.CO.NZ].name_cache.Hosted_name.TaxonConcept(taxonconceptid,
...
select bib.BibliographyGuid, BibliographyAddedDate, BibliographyUpdatedDate,
	...
	inner join [NAME_CACHE.DATABASES.LANDCARERESEARCH.CO.NZ].name_cache.Hosted_name.Name n on n.nameid = bib.BibliographyNameFk
...
from [NAME_CACHE.DATABASES.LANDCARERESEARCH.CO.NZ].name_cache.Hosted_name.TaxonConcept con
	...
	inner join [NAME_CACHE.DATABASES.LANDCARERESEARCH.CO.NZ].name_cache.Hosted_name.TaxonConcept cto on cto.taxonconceptid = bibr.BibliographyRelationshipBibliographyToFk
...
insert [NAME_CACHE.DATABASES.LANDCARERESEARCH.CO.NZ].name_cache.Hosted_name.TaxonNameUse 
...
from tblName n
inner join [NAME_CACHE.DATABASES.LANDCARERESEARCH.CO.NZ].name_cache.Hosted_name.Name n1 on n1.nameid = n.nameguid
--left join [NAME_CACHE.DATABASES.LANDCARERESEARCH.CO.NZ].name_cache.Hosted_name.TaxonConcept con on con.nameid = n.NameGuid 
left join [NAME_CACHE.DATABASES.LANDCARERESEARCH.CO.NZ].name_cache.Hosted_name.TaxonNameUse nbc on nbc.nameid = n.NameGuid 
where nbc.TaxonNameUseid is null 
	and NameParentFk <> '2F5CA98D-EE05-461D-901A-419A88071133'
	and not exists(select taxonconceptid from [NAME_CACHE.DATABASES.LANDCARERESEARCH.CO.NZ].name_cache.Hosted_name.taxonconcept 
...
inner join [NAME_CACHE.DATABASES.LANDCARERESEARCH.CO.NZ].name_cache.Hosted_name.taxonconcept tc on tc.nameid = nbc.nameid 
...
insert into [NAME_CACHE.DATABASES.LANDCARERESEARCH.CO.NZ].name_cache.Hosted_name.ConceptRelationship(
