IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[PNDCache10]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[PNDCache10]
GO
...
CREATE procedure [dbo].[PNDCache10]
as

set concat_null_yields_null off

INSERT INTO [NAME_CACHE.DATABASES.LANDCARERESEARCH.CO.NZ].name_cache.plant_name.[Name](NameId, IsScientific,
...
--	from
--	[NAME_CACHE.DATABASES.LANDCARERESEARCH.CO.NZ].name_cache.plant_name.Name na 
...
--	from [NAME_CACHE.DATABASES.LANDCARERESEARCH.CO.NZ].name_cache.plant_name.Name na
...
from dbo.tblName n ) DS
	inner join [NAME_CACHE.DATABASES.LANDCARERESEARCH.CO.NZ].name_cache.plant_name.Name na on DS.NameGuid = Na.NameId
...
from tblName n
inner join [NAME_CACHE.DATABASES.LANDCARERESEARCH.CO.NZ].name_cache.plant_name.[Name] n2 on n2.nameid = n.NameGuid
...
grant execute on dbo.[PNDCache10] to dbi_user
