...
namespace NZORTest
{
    ...
    public class UnitTest1
    {
        ...
        public void TestMatch()
        {
            ...
            IntegrationData data = new IntegrationData(provNameId, "Asterales", Guid.Empty, cs, true, cnnStr, batchId);
            it.AddNameData(data);
            it.ProcessName(null);
            ...
            data = new IntegrationData(provNameId, "Testaceae Smith", Guid.Empty, cs, true, cnnStr, batchId);
            it.AddNameData(data);
            it.ProcessName(null);
            ...
            data = new IntegrationData(provNameId, "Testgenus", Guid.Empty, cs, true, cnnStr, batchId);
            it.AddNameData(data);
            it.ProcessName(null);
            ...
            data = new IntegrationData(provNameId, "Testgenus testsp Smith", Guid.Empty, cs, true, cnnStr, batchId);
            it.AddNameData(data);
            it.ProcessName(null);
